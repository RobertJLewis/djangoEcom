...
class Order(models.Model):
    ...
    street_address1 = models.CharField(max_length=75, null=False, blank=False)
    street_address2 = models.CharField(max_length=75, null=True, blank=True)
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        super().save(*args, **kwargs)
        self.order.update_total()  # Keep order totals up-to-date
